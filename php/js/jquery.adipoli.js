        ...
        $(this).one('load', function() {
            ...
            $(this).parent().bind('mouseenter',function(){
                ...
                else if(settings.hoverEffect=='popout')
                {
                    ...
                    element.children('.adipoli-after').width(curImageWidth+6*settings.popOutMargin);
                    element.children('.adipoli-after').height(curImageHeight+6*settings.popOutMargin);
